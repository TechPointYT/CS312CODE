...
public class PhraseBank {
     ...
     * @param fileName The name of the file that has the phrase bank.
     * @param randomize Whether to randomize the phrases or use the default seeds.
     */
    ...
    /**
     * Set the altenate seed for Randomness.
     * @param newSeed 
     */
    ...
    /**
     * Set whether we should use the default seed for randomness or the alternate seed.
     * @param useDefault
     */
